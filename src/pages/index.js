...
const aboutMe = [
  'loves simple web experiences',
  'did science before coding'
]
    ...
    <ThemeProvider theme={theme}>
      ...
      <UnorderedList mb={[2]} >
        <ListItem
          ...
          includeBullet
        >
          <Text>is building things so <a href="https://www.bombas.com">Bombas</a> can help those in need</Text>
        </ListItem>
        {
          aboutMe.map(about => (
            <ListItem
      ...
      <Text><a href="mailto:jeffreyhshapiro@gmail.com">Contact Me</a></Text>
      </Container>
    </ThemeProvider>
  </div>
)
